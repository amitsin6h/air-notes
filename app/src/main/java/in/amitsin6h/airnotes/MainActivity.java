...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FloatingActionButton fabCreateNote = (FloatingActionButton) findViewById(R.id.fabCreateNote);
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.nav_all:
                ...
                break;
            case R.id.nav_categorized:
                fragment = new CategorizedFragment();
                break;
            case R.id.nav_uncategorized:
                fragment = new UncategorizedFragment();
                break;
